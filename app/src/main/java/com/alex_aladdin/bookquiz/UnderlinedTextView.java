...
//Класс взят отсюда:
//http://stackoverflow.com/a/30717100
public class UnderlinedTextView extends TextView {
    ...
    private void init(Context context, AttributeSet attributeSet, int defStyle) {
        ...
        int color = typedArray.getColor(R.styleable.UnderlinedTextView_underlineColor, 0xFFFF0000);
        ...
        mPaint.setColor(color); //line mColor
